...
let
  ...
  meta = {
    description = "HanWang Sinsong Chinese typeface";
    homepage = "https://code.google.com/archive/p/wangfonts/";
    license = licenses.gpl2Plus;

    longDescription = ''
      Provides the HanWang Sinsong family from Hann-Tzong Wang, including a
      Simplified Chinese TrueType text font.
    '';
