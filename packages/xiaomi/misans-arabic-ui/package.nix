...
let
  ...
  meta = {
    description = "MiSans Arabic UI font family";
    homepage = "https://hyperos.mi.com/font/zh/details/arabic";
    license = licenses.mi-sans-font-license;

    longDescription = ''
      Provides the MiSans Arabic UI static OpenType font family from
      Xiaomi.
...
stdenvNoCC.mkDerivation {
  ...
  installPhase = ''
    ...
    install -Dm444 -t $out/share/fonts/opentype/xiaomi \
      otf/MiSansArabicUI-Thin.otf \
      otf/MiSansArabicUI-ExtraLight.otf \
      otf/MiSansArabicUI-Light.otf \
      otf/MiSansArabicUI-Regular.otf \
      otf/MiSansArabicUI-Normal.otf \
      otf/MiSansArabicUI-Medium.otf \
      otf/MiSansArabicUI-Demibold.otf \
      otf/MiSansArabicUI-Semibold.otf \
      otf/MiSansArabicUI-Bold.otf \
      otf/MiSansArabicUI-Heavy.otf
