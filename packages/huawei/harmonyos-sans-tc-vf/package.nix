...
let
  ...
  version = "2.00-unstable-2026-06-27";
  ...
  meta = {
    description = "HarmonyOS Sans TC variable font family";
    homepage = "https://developer.huawei.com/consumer/en/design/resource/";
    license = licenses.harmonyos-sans-fonts-license;

    longDescription = ''
      Provides the HarmonyOS Sans TC variable TrueType font
      family for Traditional Chinese text from Huawei Device.
