...
let
  ...
  meta = {
    description = "HarmonyOS Sans SC variable font family";
    homepage = "https://developer.huawei.com/consumer/en/design/resource/";
    license = licenses.harmonyos-sans-fonts-license;

    longDescription = ''
      Provides the HarmonyOS Sans SC variable TrueType font
      family for Simplified Chinese text from Huawei Device.
